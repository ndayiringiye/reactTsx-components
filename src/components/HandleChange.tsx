...
const [dataForm, setDataForm] = useState<InputType>({
    email: "",
    firstName: "",
    lastName: "",
    password: "",
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>): void => {
    e.preventDefault()
    console.log("Form submitted successfully: ", dataForm)
  }
        ...
        >
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label
              ...
              dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 
              -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 
              peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 
              peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 
              peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              Confirm password
